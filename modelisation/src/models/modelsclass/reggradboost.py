...
class RegressionRandForestReg(GenericModel):
    ...
    def BuildModel(self):
        ...
        self.BuilPrepro()
        self.ModelSklearn = Pipeline([("preprocessor",self.prepro),("model", GradientBoostingRegressor())])
        self.IsBuild = True
    ...
    def objective(self,trial,X,Y):
        ...
        param = { 
        'model__n_estimators':trial.suggest_int('model__n_estimators',10,300,10),
        'model__learning_rate':trial.suggest_categorical('model__learning_rate', [0.025,0.05,0.1]),
